...
public class InMemory_2020 extends AbstractBesoldungstabelle {

	
	private Map<Integer, float[]> besoldungsordnungA;
	private SortedMap<Integer, Float> besoldungsordnungB;
	private SortedMap<String, Amtszulage[]> amtszulage;
	
	private float famZuschlagStufe1;
	private float famZuschlagStufe2;
	private float famZuschlagZweitesKind;
	private float famZuschlagWeitereKinder;
	private float aktuellerRentenwertWest;
	private float aktuellerRentenwertOst;
	private float maxAbzugPflegeleistung;
	
	public InMemory_2020() {
		initABesoldung();
		initBBesoldung();
		initFamZuschlag();
		initAmtszulage();
		initKindererziehungszuschlag();
		initAbzugPflegeleistung();
	}
	...
	@Override
	public float getMaxAbzugPflegeleistung() {
		return maxAbzugPflegeleistung;
	}
	...
	private void initKindererziehungszuschlag() {
		//Stand 01.07.2020
		this.aktuellerRentenwertWest = 34.19f;
		this.aktuellerRentenwertOst = 33.23f;
	}
	...
	private void initAbzugPflegeleistung() {
		this.maxAbzugPflegeleistung = 69.20f;
	}
	...
	@Override
	public String print() {
		return new String("Besoldungstabelle für Beamtinnen und Beamte des Bundes (Gültig ab 1. März 2020)");
	}
