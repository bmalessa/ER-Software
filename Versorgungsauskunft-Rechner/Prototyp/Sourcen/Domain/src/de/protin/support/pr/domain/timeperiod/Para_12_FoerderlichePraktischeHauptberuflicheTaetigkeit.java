 ...
 *
 */
public class Para_12_FoerderlichePraktischeHauptberuflicheTaetigkeit extends BaseTimePeriod {

	public static final String ZEITART = "Förderliche praktische hauptberufliche Tätigkeit (§12,2 BeamtVG)";
	
	public Para_12_FoerderlichePraktischeHauptberuflicheTaetigkeit(Date startDate, Date endDate, float factor) {
		super(ITimePeriod.FOERDERLICHE_PRAKTISCHE_HAUPTBERUFLICHE_TAETIGKEIT_PARA_12_2, startDate, endDate, factor);
	}
