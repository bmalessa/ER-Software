 ...
 *
 */
public class Para_12_VorgeschriebenePraktischeHauptberuflicheTaetigkeit extends BaseTimePeriod {

	public static final String ZEITART = "Praktische hauptberufliche Tätigkeit (§12,1,1 BeamtVG)";
	
	public Para_12_VorgeschriebenePraktischeHauptberuflicheTaetigkeit(Date startDate, Date endDate, float factor) {
		super(ITimePeriod.VORGESCHR_PRAKTISCHE_HAUPTBERUFLICHE_TAETIGKEIT_PARA_12_1_2, startDate, endDate, factor);
	}
