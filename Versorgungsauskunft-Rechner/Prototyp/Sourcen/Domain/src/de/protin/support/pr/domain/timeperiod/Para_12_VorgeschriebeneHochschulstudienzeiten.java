 ...
 *
 */
public class Para_12_VorgeschriebeneHochschulstudienzeiten extends BaseTimePeriod {

	public static final String ZEITART = "Vorgeschriebene Hochschulzeiten (§12,1,1 BeamtVG)";
	
	public Para_12_VorgeschriebeneHochschulstudienzeiten(Date startDate, Date endDate, float factor) {
		super(ITimePeriod.VORGESCHR_HOCHSCHULSTUDIEN_ZEITEN_PARA_12_1_1, startDate, endDate, factor);
	}
