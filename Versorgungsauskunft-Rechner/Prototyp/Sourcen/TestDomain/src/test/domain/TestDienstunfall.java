...
public class TestDienstunfall {
	...
	public void setUp() throws Exception {
		...
		objectUnderTest.setDienstunfall(true);
	...
	public void testValidation() {
		...
		//Datum der Begründung des Beamtenverh. unplausibel. Kein ruhegehaltsfähiger Zeitraum mit Start Datum 01.09.1981 vorhanden.
		//Datum des Eintritt in den Ruhestand unplausibel. Kein ruhegehaltsfähiger Zeitraum mit Ende Datum 31.07.2015 vorhanden.
	...
	public void testCalculatePension_2() {
		...
		assertEquals((double)abzugVomRuhegeld, (double)0.0f, 0.1);
		
		float ruhegehaltNachAbzug = erdientesRuhegehalt - abzugVomRuhegeld;
		assertEquals((double)ruhegehaltNachAbzug, (double)3776.14f, 0.1);
	}
