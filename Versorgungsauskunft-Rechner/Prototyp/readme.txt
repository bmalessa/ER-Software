...
Java-JRE
	Das Default-JAVA-JRE gegen das die Java-Sourcen kompiliert wurden. Kann auch zur Ausführung des Prototyp verwendet werden. Wenn keine weitere Anpassungen vorgenommen werden, sollte 
	das Batch-Skript (s.o) ohne weitere Anpassung zumindest auf einem Windows-Betriebssystem ausgeführt werden können.
