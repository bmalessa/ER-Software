 ...
 *
 */
public class Para_12_VorgeschriebeneFachschulzeiten extends BaseTimePeriod {

	public static final String ZEITART = "Vorgeschriebene Fachschulzeiten (§12,1,1 BeamtVG)";
	
	public Para_12_VorgeschriebeneFachschulzeiten(Date startDate, Date endDate, float factor) {
		super(ITimePeriod.VORGESCHR_FACHSCHULZEITEN_PARA_12_1_1, startDate, endDate, factor);
	}
