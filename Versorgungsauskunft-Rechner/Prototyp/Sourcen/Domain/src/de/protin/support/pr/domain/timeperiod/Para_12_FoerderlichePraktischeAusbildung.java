 ...
 *
 */
public class Para_12_FoerderlichePraktischeAusbildung extends BaseTimePeriod {

	public static final String ZEITART = "Förderliche praktische Ausbildung (§12,2 BeamtVG)";
	
	public Para_12_FoerderlichePraktischeAusbildung(Date startDate, Date endDate, float factor) {
		super(ITimePeriod.FOERDERLICHE_PRAKTISCHE_AUSBILDUNG_PARA_12_2, startDate, endDate, factor);
	}
